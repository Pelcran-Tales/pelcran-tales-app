...
const MainNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-[#f7f1e4] z-50 rounded-t-[9px] safe-bottom">
  <div
    className="
      mx-auto
      w-[90%]
          ...
          return (
            <div
              className={`flex items-center justify-center w-[51px] h-[45px] p-1 rounded-lg transition-colors duration-200
                ${
                  isActive
                    ? "bg-[#372d20] text-[#f7f1e4]"
                    : "bg-transparent text-[#372D20] hover:bg-[#493c2b] hover:text-[#f7f1e4]"
                } group`}
            >
